    ...
    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
          ...
          <p style="margin: 0;text-align:justify;">Please don't forget to <strong>time in/out</strong> as soon as you receive this email. Kindly disregard this if you have already performed the action, otherwise click the button below to login to your account.</p>
          </td>         
        </tr>

        <tr>
          <td>
          <center><a href="https://talms.ils.dole.gov.ph/home"><button style="border: none;
  border-radius:7px;
