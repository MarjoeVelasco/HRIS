...
class AttendanceSheets implements FromView,WithTitle
{
    /**
    ...
    */
    ...
    public function __construct($id,$from,$to,$week)
    {
    $this->id = $id;
    $this->from = $from;
    $this->to = $to;
 ...
 //collection for dates with halfday CTO
        ...
        return view('admin.attendancereport.export', [

            'users' => $sorted_merged_attendance, //collection
