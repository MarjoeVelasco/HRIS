...
<div class="card">    
    <div class="d-flex justify-content-center">
        <div class='col-lg-12 col-lg-offset-4'>
            ...
            <hr>
            {{ Form::open(array('url' => 'manageobao')) }}
            {!! csrf_field() !!}

                <div class="form-group px-5">
                    <label for="title">Entry Name</label>
                ...
                <div class="form-group px-5">
                  <label for="time_in_time">Title / Purpose</label>
                  <textarea class="form-control" name="title" required></textarea>
                </div>

                <div class="form-group px-5">
                  <label for="time_in_time">Details / Destination</label>
