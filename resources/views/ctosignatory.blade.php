         ...
         <div class="col-12 text-center">
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-7 text-left">
                  <a href="/download/leave/{{ $encrypted_leave_id }}" class="btn-sm btn-success"><span class="pcoded-micon"><i class="feather icon-download"></i></span><span class="pcoded-mtext"> Download</span></a>
                ...
                <div class="modal fade" id="approve_secondary_modal">
                        <div class="modal-dialog modal-dialog-centered">
                           <div class="modal-content">
                                 ...
                                 <a href="/signatory-approve/leave/secondary/{{$encrypted_user_id}}/{{$encrypted_leave_id}}" class="btn btn-success"><span class="pcoded-micon"><i class="feather icon-thumbs-up"></i></span><span class="pcoded-mtext"> Yes, CONFIRM</span></a>
               ...
               <div class="modal fade" id="approve_secondary_modal">
                        <div class="modal-dialog modal-dialog-centered">
                           <div class="modal-content">
                                 ...
                                 <a href="/signatory-approve/leave/primary/{{$encrypted_user_id}}/{{$encrypted_leave_id}}" class="btn btn-success"><span class="pcoded-micon"><i class="feather icon-thumbs-up"></i></span><span class="pcoded-mtext"> Approve</span></a>
                                 <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="feather icon-thumbs-down"></i>No, cancel</button>
                                 </div>
                           </div>
                        </div>
   ...
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         ...
         <center>
            ...
            <form method="post" action="/signatory-decline/leave/{{$user_role}}">
            @csrf
