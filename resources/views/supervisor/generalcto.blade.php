...
@section('title', '| CTO Requests for Approval')
@section('content')
...
<div class="col-xl-12">
   <div class="card">
      <div class="card-header">
         <h3 class="text-info">
            <i class="fa fa-clipboard"></i> General CTO Requests
            <section class="float-right">
            <a href="/supervise-general-leave" class="btn btn-outline-primary"><i class="feather icon-clipboard "></i></span><span class="pcoded-mtext"> Leave Requests</span></a>
            </section>
         </h3>
      </div>
        ...
        <td>   
         ...
         @endif
          ...
          @if($leave->status!="Cancelled")
            ...
            <a href="/review-cto-supervisor/{{ $leave->id }}/{{$leave->supervisor_id}}" class="btn-sm btn-warning"><span class="pcoded-micon"><i class="feather icon-clipboard"></i></span><span class="pcoded-mtext"> Review</span></a>
            @endif
           @endif  
