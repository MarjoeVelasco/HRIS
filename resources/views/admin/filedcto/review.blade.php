   ...
   <div class="card">
      ...
      @foreach($leaves as $leave)
         ...
         <div class="row">
            ...
            <form method="post" action="/approve-cto" id="approve_cto_form">
            @csrf
                ...
                <a href="" data-toggle="modal" data-target='#update_credits_modal' class="btn btn-success"><span class="pcoded-micon"><i class="feather icon-save"></i></span><span class="pcoded-mtext"> Save and Approve</span></a>
                ...
                <div class="modal fade" id="update_credits_modal">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="feather icon-thumbs-up "></i><span class="pcoded-mtext"> Yes, CONFIRM</span></button>
            ...
            <div class="col-12 mt-3" id="hr_disapprove_reason">
                <form method="post" action="/disapprove-cto">
                @csrf
