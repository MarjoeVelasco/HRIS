...
@section('title', '| Attendances (Holidays/Weekends)')
@section('content')
...
<div class="col-xl-12">
   <div class="card">
      <div class="card-header">
         <h3 class="text-info">
         <i class="feather icon-calendar"></i> Manage Attendance (Holidays & Weekends)
      ...
      <div class="card-block table-border-style">
                            ...
                            {{ Form::open(array('url' => 'manageattendanceothers/filter', 'method' => 'post')) }}
                            ...
                            <div class="form-group col-md-3">
                             ...
                             <div class="form-group col-md-3">           
                              ...
                              <div class="form-group col-md-3">   
                                        ...
                                        <a href="/manageattendanceothers"><button class="btn btn-outline-primary" style="margin-top:30px;" type="button"><span class="pcoded-micon"><i class="feather icon-file"></i></span><span class="pcoded-mtext"> Reset</span></button></a>
                                        </div>   
                           </div>
