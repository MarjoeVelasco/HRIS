<table>
    ...
    <tr>
    <td colspan="4">Total Required hours worked</td>
    <td>{{$expected_working_hours * 8}}:00:00</td>
    </tr>

    <tr>
    <td colspan="4">Total no. of hours worked</td>
    <td>{{$hours_worked}}</td>
    </tr>

    <tr>
    <td colspan="4">Total no. of hours late</td>
    <td>-{{$late}}</td>
    ...
    <tr>
    <td colspan="4">Total no. of hours undertime</td>
    <td>-{{$undertime}}</td>
    <td> </td>
    <td> </td>
    <td> </td>
    ...
    <tr>
    <td colspan="4">Total no. of hours overtime</td>
    <td>{{$overtime}}</td>
    </tr>
    <tr>
    <td colspan="4">Total Undertime</td>
    <td>{{$total_undertime_monthly}}</td>
    </tr>
    <tr>
    <td colspan="4">Total late and Undertime</td>
    <td>{{$total_late_undertime_monthly}}</td>
    </tr>
    ...
    <tr>
    <td colspan="4">Total no. of days on leave</td>
    <td>{{$days_absent}}</td>
    </tr>
    <tr>
    <td colspan="4">Total no. of Official Business (OB)</td>
    <td>{{$total_OB}}</td>
    </tr>
    <tr>
    <td colspan="4">Total no. of Administrative Order (AO)</td>
    <td>{{$total_AO}}</td>
    </tr>
    ...
    <tr>
    <td colspan="4"><strong>Week {{$a->week_no}}  ({{$a->from}} - {{$a->to}})</strong></td>
   
   
    </tr>  
    <tr>
    <td colspan="4">Required hours worked</td>
    <td>{{$a->expected_working_hours * 8}}:00:00</td>
    ...
    <tr>
    <td colspan="4">Total Undertime</td>
    <td>{{$a->total_undertime}}</td>
    </tr>

    <tr>
    <td colspan="4">Total late and Undertime</td>
    <td>{{$a->total_late_undertime}}</td>
    </tr>
