      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
            <p style="margin: 0;text-align:justify;">Your Leave request with leave no.# {{$id}} has been {{$leave_status}}. Please download your receiving copy or request a signed copy of your application from the HR. Thank you.</p>
          </td>
        </tr>
        <tr>
          <td>
