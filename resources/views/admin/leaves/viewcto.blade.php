...
<table class="table" style="border: 2px solid black;width:100%;" cellspacing="0">
<tr>

<td style="border-right:solid 1px;padding:7px;" width="50">
<center>
<img src="{{url('/images/ils_icon.jpg')}}" height="50px">
</center>
</td>
...
<tr>
<td colspan="4" style="border-bottom:solid 3px black;border-top:solid 1px black;padding-right:7px;padding-left:7px;">
...
<input type="checkbox" disabled> Recommended<br>
<input type="checkbox" disabled> Not Recommended due to _______<br>
