...
class CreateFiledLeavesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('filed_leaves', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('leave_attributes')->nullable();
    ...
    {
        Schema::dropIfExists('filed_leaves');
    }
}
