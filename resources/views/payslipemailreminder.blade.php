      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
          <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
            <p style="margin: 0;text-align:justify;">Your payroll for {{$period}} has been published. Please click the button below to access your payslips.</p>
          </td>
        </tr>

        <tr>
          <td>
          <center><a href="http://127.0.0.1:8000/my-payslip"><button style="border: none;
  border-radius:7px;
                ...
                <td width="260" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                    <tr>
                      ...
                      <p style="margin: 0;text-align:justify;">This is a system generated message, please do not reply. For payslip related queries, pls send your email to <a href="mailto:rjmrobles@ils.dole.gov.ph">rjmrobles@ils.dole.gov.ph</a>. 

<br><br>For technical issues, kindly create a ticket thru the <a target="_blank" href="https://nas.ils.dole.gov.ph/osticket/upload/index.php">IT Helpdesk</a></p><br>
